...
- (void)initUI {
    ...
    NSString *rescourcePath = [[NSBundle mainBundle] pathForResource:@"Frameworks⁩/PhotoAlbum.framework⁩/ZQAlbumCell" ofType:@"nib"];
    NSBundle *xibBundle = [NSBundle bundleWithPath:rescourcePath];
    [self.collectionView registerNib:[UINib nibWithNibName:@"ZQAlbumCell" bundle:xibBundle] forCellWithReuseIdentifier:NSStringFromClass([ZQAlbumCell class])];
